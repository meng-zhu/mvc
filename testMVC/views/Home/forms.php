                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form"  action="../Data/createPet" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            <label>體重</label>
                                            <input class="form-control" placeholder="體重" id="weight" name="weight">
                                        </div>
                                        <div class="form-group">
                                            <label>年齡</label>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <h1>登記人資料</h1>
                                        <div class="form-group input-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="登記人姓名" id="name" name="name" value="<?php echo $key["name"];?>"  disabled>
                                        </div>
                                        <div class="form-group">
                                            <label>連絡電話</label>
                                            <input type="tel" class="form-control" placeholder="連絡電話" id="phone" name="phone" value="<?php echo $key["phone"];?>"  disabled>
                                        </div>
                                        <div class="form-group">
                                            <label>Email</label>
                                            <input  type="email" class="form-control" placeholder="Emal" id="email" name="email" value="<?php echo $key["email"];}?>"  disabled>
                                        </div>
