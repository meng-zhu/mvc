                           ...
                           <form role="form"  action="user.php" method="post">
                                <fieldset>
                                    <div class="form-group">
                                        Email：
                                        <input class="form-control" placeholder="E-mail" name="email" type="email" autofocus value="<?php echo $row["email"];?>" disabled>
                                    </div>
                                    <div class="form-group">
                                        新密碼：
                                    ...
                                    <div id="checkpwd"></div>
                                     ...
                                     <div class="form-group">
                                         名字：
                                        <input class="form-control" placeholder="名字" name="name" type="text" autofocus value="<?php echo $row["name"];?>">
                                    </div>
                                    <div class="form-group">
                                        電話：
                                        <input class="form-control" placeholder="電話" name="phone" type="text" autofocus value="<?php echo $row["phone"]; }?>">
                                    </div>
